...
class LocalUpdateMAML(object):
    ...
    def train(self, net, c_list={}, idx=-1, lr=0.1, lr_in=0.0001, c=False, w_glob_keys=None):
        net.train()
        # train and update
        lr_in = lr * 0.001
        bias_p = []
...
class LocalUpdateScaffold(object):
    ...
    def train(self, net, c_list={}, idx=-1, lr=0.1, c=False, w_glob_keys=None):
        net.train()
        # train and update
        bias_p = []
        weight_p = []
...
class LocalUpdateDitto(object):
    ...
    def train(self, net, ind=None, w_ditto=None, lam=0, idx=-1, lr=0.1, last=False, w_glob_keys=None):
        net.train()
        # train and update
        bias_p = []
        weight_p = []
